...
function BusinessCardBottom(props) {
  return (
    <div className={cn("pt-14")}>
      <div className={cn("bg-gray-900 p-11")}>
        <div className={cn("px-8")}>
          ...
          >
            <p className={cn("text-white text-lg text-center")}>
              {props.title}
            </p>
          ...
          <div
            className={cn(
              " flex justify-center items-center transform translate-y-4"
            )}
          >
            <ReadMoreButton
              className={cn(
                "bg-white p-3 w-12/12 hover:bg-yellow-500  transition duration-500 ease-in-out text-sm font-bold"
              )}
